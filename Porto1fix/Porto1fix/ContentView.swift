...
//  Porto1fix
//
//  Created by Naufal Fachreza on 29/03/23.
//
        ...
        ZStack{
            ...
            VStack(spacing: 0){
                ...
                .padding(.bottom,UIApplication
                    ...
                    .connectedScenes
                    .flatMap { ($0 as? UIWindowScene)?.windows ?? [] }
                    .first { $0.isKeyWindow }?.safeAreaInsets.bottom == 0 ? 15 : UIApplication
                    .shared
                    .connectedScenes
                    .flatMap { ($0 as? UIWindowScene)?.windows ?? [] }
...
struct BottomView : View {
    ...
    var body: some View{
        ...
        VStack(alignment: .leading, spacing: 15) {
            ...
            Text("Aplikasi Wisataku merupakan platform digital yang memudahkan pengguna untuk menemukan destinasi wisata menarik di dalam dan luar negeri.")
...
var data = [
    ...
    Model(title: "Nusa Penida", country: "Bali", ratings: "4.9", price: "Rp. 100.000", img: "Image"),
    Model(title: "Raja Ampat", country: "Papua", ratings: "4.1", price: "Rp. 100.000", img: "Image 1"),
    Model(title: "Bromo", country: "Jawa Timur", ratings: "4.1", price: "Rp. 100.000", img: "Image 2"),
]
